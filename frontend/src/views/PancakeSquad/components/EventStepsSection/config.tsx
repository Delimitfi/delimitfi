...
const stepsConfigBuilder = ({ t, userInfos, eventInfos, userStatus, account, theme, cakeBalance }: EventStepsType) => {
  ...
  return [
    ...
    },
    {
      ...
      title: t('Hold DLM'),
      bodyText: [t('Each NFT costs DLM to mint. Remember you also need BNB to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
            href="https://app.thatangryarmytoken.com/swap?outputCurrency=0x8BF005074a59c1CcD46719A1E48b15675fCf372B"
            target="_blank"
            width="100%"
          >
            {t('Buy DLM')}
